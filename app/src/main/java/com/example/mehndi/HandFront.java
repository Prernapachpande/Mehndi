...
import com.example.mehndi.Adapter.FrontAdapter;
...
public class HandFront extends Fragment {
    private ArrayList<mehndiimg> imageList;
    private ProgressDialog pDialog;
    private RecyclerView recyclerView;
    private FrontAdapter eAdapter;
    @Override
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view = inflater.inflate(R.layout.fragment_hand_front,container,false);
        ...
        final Call<ArrayList<mehndiimg>> call = testapi.design("2");
        call.enqueue(new Callback<ArrayList<mehndiimg>>() {
            ...
            public void onResponse(Call<ArrayList<mehndiimg>> call, Response<ArrayList<mehndiimg>> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    recyclerView = (RecyclerView)view.findViewById(R.id.recycler_front);
                    eAdapter = new FrontAdapter(HandFront.this, imageList);

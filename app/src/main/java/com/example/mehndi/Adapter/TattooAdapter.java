...
import com.example.mehndi.Tattoo;
...
public class TattooAdapter extends RecyclerView.Adapter<TattooAdapter.CustomViewHolder>{
    private ArrayList<mehndiimg> m;
    private FragmentActivity context;

    public TattooAdapter(Tattoo context, ArrayList<mehndiimg> m) {
        this.context = context.getActivity();
        this.m = m;
    }

    @Override
    public TattooAdapter.CustomViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.mehndi_images, parent, false);

        return new TattooAdapter.CustomViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(TattooAdapter.CustomViewHolder holder, final int position) {

...
import com.example.mehndi.HandBack;
...
public class BackAdapter extends RecyclerView.Adapter<BackAdapter.CustomViewHolder> {
    private ArrayList<mehndiimg> m;
    private FragmentActivity context;

    public BackAdapter(HandBack context, ArrayList<mehndiimg> m) {
        this.context = context.getActivity();
        this.m = m;
    }

    @Override
    public BackAdapter.CustomViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.mehndi_images, parent, false);

        return new BackAdapter.CustomViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(BackAdapter.CustomViewHolder holder, final int position) {
